...
namespace ru_ssian_roulette
{
    public partial class Main : Form
    {
        ...
        private void button_load(object sender, EventArgs e)
        {
            ...
            Image img = Image.FromFile(@"C:\Users\AJAYPAL\Desktop\ru_ssian roulette\Res\load.gif");
            pictureBox1.Image = img;
            // this code play sound
            System.Media.SoundPlayer player = new System.Media.SoundPlayer(@"C:\Users\AJAYPAL\Desktop\ru_ssian roulette\Res\load.wav");
            player.Play();
            main.load = 1;
        ...
        { // this code display gif
            Image img = Image.FromFile(@"C:\Users\AJAYPAL\Desktop\ru_ssian roulette\Res\spin.gif");
            pictureBox1.Image = img;
            // this code play sound
            System.Media.SoundPlayer player = new System.Media.SoundPlayer(@"C:\Users\AJAYPAL\Desktop\ru_ssian roulette\Res\spin.wav");
            player.Play();
        ...
        {
            main.shoot = 0;
            Image img = Image.FromFile(@"C:\Users\AJAYPAL\Desktop\ru_ssian roulette\Res\shoot.gif");
            pictureBox1.Image = img;
            System.Media.SoundPlayer player = new System.Media.SoundPlayer(@"C:\Users\AJAYPAL\Desktop\ru_ssian roulette\Res\shoot.wav");
            player.Play();
            do
            {
